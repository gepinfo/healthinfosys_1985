...
export class headerblkController implements Controller {
    ...
    private initializeRoutes() {
        this.router.delete('/headerblk/:id', this.GpDelete);
this.router.get('/headerblk/get/search', this.GpSearch);
this.router.put('/headerblk/get/update', this.GpSearchForUpdate);
this.router.put('/headerblk', this.GpUpdate);
this.router.get('/headerblk/:id', this.GpGetEntityById);
this.router.get('/headerblk', this.GpGetAllValues);
this.router.post('/headerblk', this.GpCreate);
this.router.get('/headerblk/userid/created_by', this.GpGetNounCreatedBy);
        //#@gepdelimeterone@#
        //#@ssofacebookapiroute@#
        //#@ssogithubapiroute@#
        //#@gepbankingapiroute@#
...
public GpDelete(req: Request, res: Response) {
        ...
        new ApiAdapter().delete(Constant.HEADERBLKURL + `${req.url}` )
...
public GpSearch(req: Request, res: Response) {
        ...
        new ApiAdapter().get(Constant.HEADERBLKURL + `${req.url}` )
        .then((res: any) => res.response.json()).then(result => {
            switch(req.baseUrl) { case '/mobile': res.send(result); break; case '/web': res.send(result); break; default: res.send(null); }
...
public GpSearchForUpdate(req: Request, res: Response) {
        ...
        new ApiAdapter().put(Constant.HEADERBLKURL + `${req.url}` , req.body)
        .then((res: any) => res.response.json()).then(result => {
            switch(req.baseUrl) { case '/mobile': res.send(result); break; case '/web': res.send(result); break; default: res.send(null); }
...
public GpCreate(req: Request, res: Response) {
        ...
        new ApiAdapter().post(Constant.HEADERBLKURL + `${req.url}` , req.body)
        .then((res: any) => res.response.json()).then(result => {
            switch(req.baseUrl) { case '/mobile': res.send(result); break; case '/web': res.send(result); break; default: res.send(null); }
