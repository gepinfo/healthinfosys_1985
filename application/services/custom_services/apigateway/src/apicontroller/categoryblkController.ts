...
export class categoryblkController implements Controller {
    ...
    private initializeRoutes() {
        this.router.delete('/categoryblk/:id', this.GpDelete);
this.router.get('/categoryblk/get/search', this.GpSearch);
this.router.put('/categoryblk/get/update', this.GpSearchForUpdate);
this.router.put('/categoryblk', this.GpUpdate);
this.router.get('/categoryblk/:id', this.GpGetEntityById);
this.router.get('/categoryblk', this.GpGetAllValues);
this.router.post('/categoryblk', this.GpCreate);
this.router.get('/categoryblk/userid/created_by', this.GpGetNounCreatedBy);
        //#@gepdelimeterone@#
        //#@ssofacebookapiroute@#
        //#@ssogithubapiroute@#
        //#@gepbankingapiroute@#
...
public GpDelete(req: Request, res: Response) {
        ...
        new ApiAdapter().delete(Constant.CATEGORYBLKURL + `${req.url}` )
...
public GpSearch(req: Request, res: Response) {
        ...
        new ApiAdapter().get(Constant.CATEGORYBLKURL + `${req.url}` )
        .then((res: any) => res.response.json()).then(result => {
            switch(req.baseUrl) { case '/mobile': res.send(result); break; case '/web': res.send(result); break; default: res.send(null); }
...
public GpSearchForUpdate(req: Request, res: Response) {
        ...
        new ApiAdapter().put(Constant.CATEGORYBLKURL + `${req.url}` , req.body)
        .then((res: any) => res.response.json()).then(result => {
            switch(req.baseUrl) { case '/mobile': res.send(result); break; case '/web': res.send(result); break; default: res.send(null); }
...
public GpCreate(req: Request, res: Response) {
        ...
        new ApiAdapter().post(Constant.CATEGORYBLKURL + `${req.url}` , req.body)
        .then((res: any) => res.response.json()).then(result => {
            switch(req.baseUrl) { case '/mobile': res.send(result); break; case '/web': res.send(result); break; default: res.send(null); }
